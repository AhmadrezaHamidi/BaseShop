using AutoMapper;
using hoshmand.cardisposal.Application.Contracts;
using hoshmand.cardisposal.Application.Dtos.Auth;
using hoshmand.cardisposal.Domain.Entities.Users;
using hoshmand.cardisposal.Infrastructure;
...
namespace Hoshmand.CarDisposal.Persistance.Identity
{
    public class TokenInfoService : ITokenInfoService
    {
        ...
        private readonly CarDisposalDbContext _db;
        public TokenInfoService(CarDisposalDbContext db
